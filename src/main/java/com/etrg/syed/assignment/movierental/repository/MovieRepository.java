...
/** Repo class for fetching movie Can be enhanced with actual database and ORM if needed */
@Repository
public class MovieRepository {
  private final Map<String, Movie> movies = new HashMap<>();

  // simulating db operation using map, as there is no JpaRepository, we interact direct with map.
